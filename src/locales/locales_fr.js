export const fr = {
  ...
  journey_media_ar: 'Média (arabe)',
  journey_media_en: 'Média (anglais)',
  journey_media_keep_same: 'Utiliser le même média pour les deux langues',
  journey_title: 'Titre',
  journey_title_required: 'Saisissez un titre dans chaque langue.',
  ...
  map_relation_no_results: 'Aucune carte correspondante',
  map_relation_search_prompt: 'Commencez à taper pour rechercher des cartes',
  ...
  move_to_journey: 'Déplacer vers un parcours',
  nested_map: 'Carte imbriquée',
  nested_map_description: 'Point d\'intérêt qui ouvre une autre carte au clic',
  nested_map_linked_map: 'Carte liée',
  nested_map_linked_map_required: 'Choisissez une carte vers laquelle ce point doit renvoyer.',
  ...
  poi_description_placeholder: 'Décrivez ce point d\'intérêt…',
  poi_description_section: 'Description',
  poi_language: "Langue",
  poi_latitude: 'Latitude',
  poi_latitude_invalid: 'La latitude doit être comprise entre -90 et 90.',
  poi_longitude: 'Longitude',
  poi_longitude_invalid: 'La longitude doit être comprise entre -180 et 180.',
  poi_media_ar: 'Média (arabe)',
  poi_media_en: 'Média (anglais)',
  poi_media_keep_same: 'Utiliser le même média pour les deux langues',
  poi_media_no_results: 'Aucun résultat correspondant',
  poi_media_search_prompt: 'Commencez à taper pour rechercher',
  poi_media_source_iiif_image: 'Image IIIF',
  poi_media_source_media_item: 'Élément média',
  poi_media_source_upload: 'Bibliothèque média',
  poi_mode: 'Interaction avec la carte',
  poi_mode_move: 'Se déplacer sur la carte',
  poi_mode_target: 'Placer le point',
  poi_move_hint: 'Faites glisser pour vous déplacer sur la carte. Passez à l\'outil cible, en haut à droite de la carte, pour placer ou déplacer le point.',
  pois_mode_target: 'Déplacer les points',

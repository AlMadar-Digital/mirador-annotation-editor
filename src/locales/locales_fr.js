export const fr = {
  ...
  poi_language: "Langue",
  poi_media_item: 'Élément média',
  poi_media_item_no_results: 'Aucun élément média correspondant',
  poi_media_item_search_prompt: 'Commencez à taper pour rechercher des éléments média',
